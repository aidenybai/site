...
We serve the silent majority of potential volunteers who want to help the community but don't have the time to commit to a volunteer organization. We're a non-profit, volunteer-led organization that's committed to helping people like you claim volunteer hours when you need it (sporatic one-time activities or scheduled volunteering both count!)
...
Additionally, **YourHours provides [Presidential Volunteer Service Award](https://presidentialserviceawards.gov/) opportunities** for students who volunteer under YourHours. These prestigious awards are given to dedicated volunteers that spend hundreds of hours on helping others. We recommend checking you to check [eligibility requirements](https://presidentialserviceawards.gov/eligibility).

[**💤 Skip the pitch →**](#ix27m-interested)
...
YourHours aims to solve this problem. Instead of taking the centralized, systematic approach of organizations, **YourHours prioritizes your willingness to volunteer**.
